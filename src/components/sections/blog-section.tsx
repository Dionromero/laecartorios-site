    ...
    <section id="blog" className="bg-lae-paper py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-3 text-balance text-3xl font-bold tracking-tight text-lae-ink sm:text-4xl">
            Blog da LAE
          </h2>
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`} className="group">
                <Card className="flex h-full flex-col overflow-hidden border-lae-amber/40">
                  ...
                  <CardContent className="flex flex-1 flex-col">
                    ...
                    <h3 className="mt-2 text-lg font-semibold leading-snug text-lae-ink group-hover:text-lae-amber-deep">
                      {post.title}
                    </h3>
        ...
        <div className="mt-10 text-center">
          <Link
            href="/blog"
            className="inline-flex items-center gap-1 text-sm font-medium italic text-lae-stone transition-colors hover:text-lae-ink"
          >
